...
const DialogOverlay: FC<ComponentPropsWithRef<typeof DialogPrimitive.Overlay>> =
  ({ className, ...props }) => (
...
const DialogContent: FC<ComponentPropsWithRef<typeof DialogPrimitive.Content> & { showCloseButton?: boolean }> =
...
const DialogDescription: FC<ComponentPropsWithRef<typeof DialogPrimitive.Description>> =
  ({ className, ...props }) => (
