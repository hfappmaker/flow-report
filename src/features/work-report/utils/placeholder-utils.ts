...
export const AVAILABLE_PLACEHOLDERS: PlaceholderDefinition[] = [
  ...
  },
  {
    key: "基本開始時刻",
    label: "基本開始時刻",
    description: "契約の基本開始時刻",
    example: "9:00",
  },
  {
    key: "基本終了時刻",
    label: "基本終了時刻",
    description: "契約の基本終了時刻",
    example: "18:00",
  },
  {
    key: "基本休憩時間",
    label: "基本休憩時間",
    description: "契約の基本休憩時間",
    example: "1:00",
  },
  {
    key: "1日あたりの作業単位",
    label: "1日あたりの作業単位",
    description: "日次作業単位（分）",
    example: "480分",
  },
  {
    key: "1ヶ月あたりの作業単位",
    label: "1ヶ月あたりの作業単位",
    description: "月次作業単位（分）",
    example: "10080分",
  },
  {
    key: "備考",
