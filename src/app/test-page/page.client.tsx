...
import {
  ...
  Test,
  createTestAction,
} from "@/features/test/actions/test";
import {
  DeserializeBuiltInObject,
  SerializedType,
...
export default function TestPageClient({
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      createTestAction({
        ...
        testObject: {
          ...test.testObject,
          age: new Prisma.Decimal(test.testObject.age),
        },
      });
    };
  ...
  return (
    <div>
      ...
      <p>
        Test Decimal:{" "}
        {DeserializeBuiltInObject(testDecimal, Prisma.Decimal).toString()}
      </p>
      <p>
        Test Array:{" "}
        {testArray
          .map((item) =>
            DeserializeBuiltInObject(item, Prisma.Decimal).toString(),
          )
          .join(", ")}
      </p>
      ...
      <p>
        Test Object:{" "}
        {DeserializeBuiltInObject(testObject.age, Prisma.Decimal).toString()}
      </p>
