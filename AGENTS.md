# flow-report Project Rules for AI Agents
...
- Prefer focused tests or type checks that match the scope of the change

### File Operations

- Prefer fast search tools such as `rg` / `rg --files` for text and file discovery when available
